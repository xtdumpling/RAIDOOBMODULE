 ...
 * --------------------------------------------------*/
//HSX_PER_LANE_EPARAM_LINK_INFO  X11SPGPerLanesEparamTable[] = {
//};
//UINT32 X11SPGPerLanesEparamTableSize = sizeof (X11SPGPerLanesEparamTable);
...
)
{
    ...
    if(!Status){
        mSmcAOCPeiProtocol->SmcAOCPeiCardDetection(PeiServices, 0, 0xe2, 0x10, SXB1_SLOT_INFO_Tbl,
                        sizeof(SXB1_SLOT_INFO_Tbl)/sizeof(SMC_SLOT_INFO));      //mux ch4
        mSmcAOCPeiProtocol->SmcAOCPeiCardDetection(PeiServices, 0, 0xe2, 0x08, SXB2_SLOT_INFO_Tbl,
                        sizeof(SXB2_SLOT_INFO_Tbl)/sizeof(SMC_SLOT_INFO));      //mux ch3
        mSmcAOCPeiProtocol->SmcAOCPeiCardDetection(PeiServices, 0, 0xe2, 0x04, SXB3_SLOT_INFO_Tbl,
                        sizeof(SXB3_SLOT_INFO_Tbl)/sizeof(SMC_SLOT_INFO));      //mux ch2
        mSmcAOCPeiProtocol->SmcAOCPeiBifurcation(SetupData, DefaultIOU0,
                        DefaultIOU1, DefaultIOU2);
        mSmcAOCPeiProtocol->SmcAOCPeiSetNVMeMode(PeiServices, 0, 0xe2, 0x10, SXB1_SLOT_INFO_Tbl,
                        sizeof(SXB1_SLOT_INFO_Tbl)/sizeof(SMC_SLOT_INFO));
        mSmcAOCPeiProtocol->SmcAOCPeiSetNVMeMode(PeiServices, 0, 0xe2, 0x08, SXB2_SLOT_INFO_Tbl,
                        sizeof(SXB2_SLOT_INFO_Tbl)/sizeof(SMC_SLOT_INFO));
        mSmcAOCPeiProtocol->SmcAOCPeiSetNVMeMode(PeiServices, 0, 0xe2, 0x04, SXB3_SLOT_INFO_Tbl,
                        sizeof(SXB3_SLOT_INFO_Tbl)/sizeof(SMC_SLOT_INFO));
    }
#endif
...
//----------------------------------------------------------------------------
//<AMI_PHDR_START>
EFI_STATUS EFIAPI X11SPGPeiDriverInit(
