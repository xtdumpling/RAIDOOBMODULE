...
//----------------------------------------------------------------------------
//
// Procedure:   X11SPGPowerButtonSmiHandler
//
...
EFI_STATUS X11SPGSmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
