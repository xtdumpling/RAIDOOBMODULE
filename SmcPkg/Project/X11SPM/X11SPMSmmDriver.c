...
//----------------------------------------------------------------------------
//
// Procedure:   X11SPMPowerButtonSmiHandler
//
...
EFI_STATUS X11SPMSmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
