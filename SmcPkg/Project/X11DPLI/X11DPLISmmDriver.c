...
//----------------------------------------------------------------------------
//
// Procedure:   X11DPLIPowerButtonSmiHandler
//
...
EFI_STATUS X11DPLISmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
