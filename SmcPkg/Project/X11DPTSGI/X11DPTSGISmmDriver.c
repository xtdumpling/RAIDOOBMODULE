...
//----------------------------------------------------------------------------
//
// Procedure:   X11DPTSGIS1SmiHandler
//
...
//----------------------------------------------------------------------------
//
// Procedure:   X11DPTSGIS3SmiHandler
//
...
//----------------------------------------------------------------------------
//
// Procedure:   X11DPTSGIS4SmiHandler
//
...
//----------------------------------------------------------------------------
//
// Procedure:   X11DPTSGIS5SmiHandler
//
...
//----------------------------------------------------------------------------
//
// Procedure:   X11DPTSGIPowerButtonSmiHandler
//
...
//<AMI_PHDR_END>
EFI_STATUS
X11DPTSGIPowerButtonSmiHandler (
    IN EFI_HANDLE        DispatchHandle,
    IN CONST VOID        *DispatchContext,
    IN OUT VOID          *CommonBuffer,
    IN OUT UINTN         *CommonBufferSize
...
EFI_STATUS X11DPTSGISmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
