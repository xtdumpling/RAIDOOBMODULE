...
//----------------------------------------------------------------------------
//
// Procedure:   X11DPFRPowerButtonSmiHandler
//
...
EFI_STATUS X11DPFRSmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
