...
//<AMI_PHDR_START>
//----------------------------------------------------------------------------
// Procedure:   X11DPXReadyToBootCallBack
//
...
)
{
    ...
    DEBUG((EFI_D_INFO, "X11DPXReadyToBootCallBack Entry.\n"));
...
)
{
    ...
    EFI_EVENT	X11DPXReadyToBootEvent;
    ...
    DEBUG((EFI_D_INFO, "X11DPXDxeDriverInit Init\n"));
    ...
    DEBUG((EFI_D_INFO, "Exit X11DPXDxeDriverInit Init\n"));
