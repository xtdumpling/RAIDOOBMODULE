...
//----------------------------------------------------------------------------
//
// Procedure:   X11DPXPowerButtonSmiHandler
//
...
EFI_STATUS X11DPXSmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
