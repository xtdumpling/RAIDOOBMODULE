...
//----------------------------------------------------------------------------
//
// Procedure:   X11DDWPowerButtonSmiHandler
//
...
EFI_STATUS X11DDWSmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
