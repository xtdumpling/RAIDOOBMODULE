...
//
//  Rev. 1.02
//    Bug Fix:  Move NVDIMM code to SmcNVDIMM module.
//    Reason:   
//    Auditor:  Leon Xu
//    Date:     Mar/16/2017
//
//  Rev. 1.01
//    Bug Fix:  Improve the NVDIMM code
//    Reason:   
//    Auditor:  Leon Xu
//    Date:     Sep/16/2016
//
...
//----------------------------------------------------------------------------
//
// Procedure:   ProjectPowerButtonSmiHandler
//
...
EFI_STATUS ProjectSmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
