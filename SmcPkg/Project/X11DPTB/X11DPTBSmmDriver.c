...
//----------------------------------------------------------------------------
//
// Procedure:   X11DPTBPowerButtonSmiHandler
//
...
EFI_STATUS X11DPTBSmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
