...
//----------------------------------------------------------------------------
//
// Procedure:   X11SPLPowerButtonSmiHandler
//
...
EFI_STATUS X11SPLSmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
