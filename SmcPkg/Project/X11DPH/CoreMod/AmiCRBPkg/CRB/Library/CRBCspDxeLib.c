...
//  File History
//  Rev. 1.01
//    Bug fixed:   correct sSATA port number according to silk print.
//    Reason:
//    Auditor:     Max Mu
//    Date:        May/09/2017
//
...
#ifdef X11DPH_SUPPORT
UINT8 ssata_silk_port[] = {
        0xFF,  /* port 0 silk name, 0xFF means invalid */
        0xFF,  /* port 1 silk name, 0xFF means invalid */
        0xFF,  /* port 2 silk name, 0xFF means invalid */
        0xFF,  /* port 3 silk name, 0xFF means invalid */
        0x00,  /* port 4 silk name, 0xFF means invalid */
        0x01,  /* port 4 silk name, 0xFF means invalid */
    };
#endif
...
)
{
    ...
    if( ControllerNo == SSATACONTROLLER ) {
        ...
        TempStr[5] = 0x20;
#ifdef X11DPH_SUPPORT
        TempStr[8] = ssata_silk_port[PortNumber] + 0x30;
#endif
...
EFI_STATUS CreateStringForAllDrives(BBS_TABLE *BbsTable)
{
    ...
    DEBUG((EFI_D_INFO, "[MaxMu]Class : %x , SubClass: %x, SerialNumber : %s\n", Class, SubClass, SerialNumber));
