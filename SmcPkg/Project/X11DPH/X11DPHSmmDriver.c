...
//----------------------------------------------------------------------------
//
// Procedure:   X11DPHPowerButtonSmiHandler
//
...
EFI_STATUS X11DPHSmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
