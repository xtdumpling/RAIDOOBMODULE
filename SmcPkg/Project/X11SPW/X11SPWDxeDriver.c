...
//
//  Rev. 1.06
//    Bug Fix:  Fixed system hang at POST when token "DEBUG_MODE" enabled.
//    Reason:   
//    Auditor:  Jimmy Chiu
//    Date:     May/15/2017 
// 
...
X11SPWSmbiosUpdate()
{
    ...
    DEBUG((EFI_D_INFO, "X11SPW SmbiosUpdate entry.\n"));   
    ...
    if(Strcmp(Product, "X11SPW-TF") == 0) {
        DEBUG((EFI_D_INFO, "Model X11SPW-TF detected.\n"));
    ...
    DEBUG((EFI_D_INFO, "X11SPW SmbiosUpdate end.\n"));
}
...
{
    DEBUG((EFI_D_INFO, "SetProjectPciECTLE entry.\n"));
    DEBUG((EFI_D_INFO, "SetProjectPciECTLE end.\n"));
    return EFI_SUCCESS;
}
 */
...
//<AMI_PHDR_START>
//----------------------------------------------------------------------------
// Procedure:   X11SPWReadyToBootCallBack
//
...
)
{
    ...
    DEBUG((EFI_D_INFO, "X11SPWReadyToBootCallBack Entry.\n"));
...
)
{
    ...
    EFI_EVENT	X11SPWReadyToBootEvent, HideItemEvent;
    VOID        *HideItemReg;
