 ...
 * --------------------------------------------------*/
//HSX_PER_LANE_EPARAM_LINK_INFO  X11SPWPerLanesEparamTable[] = {
//};
//UINT32 X11SPWPerLanesEparamTableSize = sizeof (X11SPWPerLanesEparamTable);
...
//----------------------------------------------------------------------------
//<AMI_PHDR_START>
EFI_STATUS EFIAPI X11SPWPeiDriverInit(
