...
//----------------------------------------------------------------------------
//
// Procedure:   X11SPWPowerButtonSmiHandler
//
...
EFI_STATUS X11SPWSmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
