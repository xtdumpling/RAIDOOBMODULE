...
//----------------------------------------------------------------------------
//
// Procedure:   X11SPHPowerButtonSmiHandler
//
...
EFI_STATUS X11SPHSmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
