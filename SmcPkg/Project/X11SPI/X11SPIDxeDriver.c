...
//  File History
//
//  Rev. 1.02   Fix MAC show incorrect in IPMI WEB..
//    Bug Fix:
//    Reason:   
//    Auditor:  Kasber Chen
//    Date:     Sep/12/2016  
...
//<AMI_PHDR_START>
//----------------------------------------------------------------------------
// Procedure:   X11SPIReadyToBootCallBack
//
...
)
{
    ...
    DEBUG((EFI_D_INFO, "X11SPIReadyToBootCallBack Entry.\n"));
...
)
{
    ...
    EFI_EVENT	X11SPIReadyToBootEvent, HideItemEvent;
    VOID        *HideItemReg;
