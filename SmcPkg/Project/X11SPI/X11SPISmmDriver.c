...
//----------------------------------------------------------------------------
//
// Procedure:   X11SPIPowerButtonSmiHandler
//
...
EFI_STATUS X11SPISmmDriverInit (
    IN EFI_HANDLE           ImageHandle,
    IN EFI_SYSTEM_TABLE     *SystemTable )
{
