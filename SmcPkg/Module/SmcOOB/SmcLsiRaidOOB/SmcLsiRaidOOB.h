...
EFI_STATUS							HandleBuildRaidCmd						(SMC_LSI_RAID_OOB_SETUP_PROTOCOL* , SMC_RAID_CMD_SET* , RAID_CMD_PROCESSING_MAP* );
EFI_STATUS							HandleBuildRaidCmd_D					(SMC_LSI_RAID_OOB_SETUP_PROTOCOL* , SMC_RAID_CMD_SET* , RAID_CMD_PROCESSING_MAP* );
EFI_STATUS							HandleOtherRaidCmd						(SMC_LSI_RAID_OOB_SETUP_PROTOCOL* , SMC_RAID_CMD_SET* , RAID_CMD_PROCESSING_MAP* );
