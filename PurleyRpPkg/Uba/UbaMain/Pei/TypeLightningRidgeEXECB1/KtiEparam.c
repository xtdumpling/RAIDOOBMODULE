...
ALL_LANES_EPARAM_LINK_INFO  LightningRidgeEXECB1AllLanesEparamTable[] = {
  //
...
//PER_LANE_EPARAM_LINK_INFO  KtiLightningRidgeEXECB1PerLaneEparamTable[] = { 0 };
PLATFORM_KTI_EPARAM_UPDATE_TABLE  TypeLightningRidgeEXECB1KtiEparamUpdate =
{
  PLATFORM_KTIEP_UPDATE_SIGNATURE,
  PLATFORM_KTIEP_UPDATE_VERSION,
  LightningRidgeEXECB1AllLanesEparamTable,
  sizeof (LightningRidgeEXECB1AllLanesEparamTable),
  NULL,
  0
};
...
)
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeLightningRidgeEXECB1KtiEparamUpdate, 
                                 sizeof(TypeLightningRidgeEXECB1KtiEparamUpdate)
                                 );
