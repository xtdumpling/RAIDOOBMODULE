...
ALL_LANES_EPARAM_LINK_INFO  LightningRidgeEXECB2AllLanesEparamTable[] = {
  //
...
//PER_LANE_EPARAM_LINK_INFO  KtiLightningRidgeEXECB2PerLaneEparamTable[] = { 0 };
PLATFORM_KTI_EPARAM_UPDATE_TABLE  TypeLightningRidgeEXECB2KtiEparamUpdate =
{
  PLATFORM_KTIEP_UPDATE_SIGNATURE,
  PLATFORM_KTIEP_UPDATE_VERSION,
  LightningRidgeEXECB2AllLanesEparamTable,
  sizeof (LightningRidgeEXECB2AllLanesEparamTable),
  NULL,
  0
};
...
)
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeLightningRidgeEXECB2KtiEparamUpdate, 
                                 sizeof(TypeLightningRidgeEXECB2KtiEparamUpdate)
                                 );
