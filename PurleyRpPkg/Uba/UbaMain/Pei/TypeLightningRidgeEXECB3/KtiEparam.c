...
ALL_LANES_EPARAM_LINK_INFO  LightningRidgeEXECB3AllLanesEparamTable[] = {
  //
...
//PER_LANE_EPARAM_LINK_INFO  KtiLightningRidgeEXECB3PerLaneEparamTable[] = { 0 };
PLATFORM_KTI_EPARAM_UPDATE_TABLE  TypeLightningRidgeEXECB3KtiEparamUpdate =
{
  PLATFORM_KTIEP_UPDATE_SIGNATURE,
  PLATFORM_KTIEP_UPDATE_VERSION,
  LightningRidgeEXECB3AllLanesEparamTable,
  sizeof (LightningRidgeEXECB3AllLanesEparamTable),
  NULL,
  0
};
...
)
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeLightningRidgeEXECB3KtiEparamUpdate, 
                                 sizeof(TypeLightningRidgeEXECB3KtiEparamUpdate)
                                 );
