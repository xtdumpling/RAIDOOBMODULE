...
ALL_LANES_EPARAM_LINK_INFO  KtiNeonCityFPGAAllLanesEparamTable[] = {
  //
  ...
  {0x0, (1 << SPEED_REC_96GT)                         , (1 << KTI_LINK2), 0x2D3A323F, ADAPTIVE_CTLE},
  ...
  {0x1, (1 << SPEED_REC_96GT)                         , (1 << KTI_LINK2), 0x2D3A323F, ADAPTIVE_CTLE}

};

//PER_LANE_EPARAM_LINK_INFO  KtiNeonCityFPGAPerLaneEparamTable[] = { 0 };

PLATFORM_KTI_EPARAM_UPDATE_TABLE  TypeNeonCityFPGAKtiEparamUpdate =
{
  PLATFORM_KTIEP_UPDATE_SIGNATURE,
  PLATFORM_KTIEP_UPDATE_VERSION,
  KtiNeonCityFPGAAllLanesEparamTable,
  sizeof (KtiNeonCityFPGAAllLanesEparamTable),
  NULL,
  0
};
...
)
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeNeonCityFPGAKtiEparamUpdate, 
                                 sizeof(TypeNeonCityFPGAKtiEparamUpdate)
                                 );
