...
ALL_LANES_EPARAM_LINK_INFO  LightningRidgeEXRPAllLanesEparamTable[] = {
  //
...
//PER_LANE_EPARAM_LINK_INFO  KtiLightningRidgeEXRPPerLaneEparamTable[] = { 0 };
PLATFORM_KTI_EPARAM_UPDATE_TABLE  TypeLightningRidgeEXRPKtiEparamUpdate =
{
  PLATFORM_KTIEP_UPDATE_SIGNATURE,
  PLATFORM_KTIEP_UPDATE_VERSION,
  LightningRidgeEXRPAllLanesEparamTable,
  sizeof (LightningRidgeEXRPAllLanesEparamTable),
  NULL,
  0
};
...
)
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeLightningRidgeEXRPKtiEparamUpdate, 
                                 sizeof(TypeLightningRidgeEXRPKtiEparamUpdate)
                                 );
