...
//
#define PCAT_RTC_INDEX_ALT        0x74
#define PCAT_RTC_TARGET_ALT       0x75
#define PCAT_RTC_EXT_INDEX_ALT    0x76
#define PCAT_RTC_EXT_TARGET_ALT   0x77
#define PCAT_RTC_INDEX_MASK       0x7F
