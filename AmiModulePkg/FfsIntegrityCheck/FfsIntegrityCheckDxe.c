...
//****************************************************************************
/** @file 
  This provides a check on FFS files and FVs in the DXE

  This file contains the function that is eLinked into the DXE RomLayout eLink.
...
*/
BOOLEAN CheckFvAndFfsIntegrityDxe(IN OUT AMI_ROM_AREA *Area)
{
    EFI_STATUS Status;
    ...
    DEBUG((-1, "Enter CheckFvAndFfsIntegrityDxe\n"));
    // error checking
