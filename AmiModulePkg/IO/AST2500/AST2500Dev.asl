...
//======================================================================
    Name(CRS, ResourceTemplate(){
        ...
        IO(Decode16, 0, 0, 0, 0, IO1)   // SWC IO space
        IO(Decode16, 0, 0, 0, 0, IO2)   // PM1b_EVT IO space
        IO(Decode16, 0, 0, 0, 0, IO3)   // PM1b_CNT IO space
        IO(Decode16, 0, 0, 0, 0, IO4)   // GPE1_BLK IO space
        IO(Decode16, 0, 0, 0, 0, IO5)   // MAILBOX IO space
    })
    ...
    // We keep category 0x00~0x0F as SIO_DEV_STATUS layout in AmiGenericSio.h to Update IOST 
        ...
        0xFF,    //  10 - CIR ------------ 0x00
        0x0B,    //  11 - Serial C (SP3) -   01
        0x0C,    //  12 - Serial D (SP4) -   02
