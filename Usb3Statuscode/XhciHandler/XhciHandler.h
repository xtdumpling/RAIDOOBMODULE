...
//**********************************************************************
// $Header: /AptioV/SRC/Usb3Statuscode/XhciHandler/XhciHandler.h 1     8/27/15 2:28p Sudhirv $
//
// $Revision: 1 $
//
// $Date: 8/27/15 2:28p $
...
// Revision History
// ----------------
// $Log: /AptioV/SRC/Usb3Statuscode/XhciHandler/XhciHandler.h $
// 
...
#ifndef __XHCI_HANDLER__
#define __XHCI_HANDLER__
...
#define AMI_XHCI_HANDLER_HOB_GUID \
    {0x8006d381, 0x5135, 0x42c5, 0x8d, 0x70, 0x2c, 0xa3, 0x5c, 0xac, 0xce, 0x53}
...
typedef struct _XHCI_HANDLER
{
	...
	UINT8	gGlobalBuf[512];
	USB3_DEBUG_PORT_HANDLE	*mDbgUsb3DebugPortHandle;
}XHCI_HANDLER;
