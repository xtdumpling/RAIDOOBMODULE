...
//
  TimerAddr = ((PciRead16 (PCI_LIB_ADDRESS(PcdGet32 (PcdPerfPkgPchPmBaseBusNumber),     \
                                          PcdGet32 (PcdPerfPkgPchPmBaseDeviceNumber),   \
                                          PcdGet32 (PcdPerfPkgPchPmBaseFunctionNumber), \
                                          R_ICH_LPC_ACPI_BASE)))  & B_ICH_LPC_ACPI_BASE_BAR) + R_ACPI_PM1_TMR;
//
