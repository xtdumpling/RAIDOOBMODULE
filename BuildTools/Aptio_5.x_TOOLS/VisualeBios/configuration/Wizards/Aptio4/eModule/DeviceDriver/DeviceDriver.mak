...
#************************************************************************//
# $Header: /VisualeBios/Src/Applications/Veb/Projects/WizTemplate/NCW/Aptio4/eModule/DeviceDriver/DeviceDriver.mak 1     2/06/06 12:20p Igork $
#
# $Revision: 1 $
#
# $Date: 2/06/06 12:20p $
...
# Revision History
# ----------------
# $Log: /VisualeBios/Src/Applications/Veb/Projects/WizTemplate/NCW/Aptio4/eModule/DeviceDriver/DeviceDriver.mak $
## 
...
LIBS = \
	...
	$(LIB_DIR)\protocollib.lib 

IMAGE_ENTRY_POINT = DeviceDriverEntry
#//**********************************************************************//
#//**********************************************************************//
#//**                                                                  **//
#//**        (C)Copyright 1985-2003, American Megatrends, Inc.         **//
