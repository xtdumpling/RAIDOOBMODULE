...
ifneq ($(PLATFORM_SET_ACTIVE),)
PROJECT_IPL = projectipl.ldl

PARSE_VEB_FLAGS+=/p$(PLATFORM_SET_ACTIVE) /a$(PROJECT_IPL)
AMI_SDL_FLAGS+=/m$(PROJECT_IPL)
endif

ifeq ($(call __ge, $(BUILD_TOOLS_VERSION), 27),yes)
# Modify ParseVeB to generate MD5 output
PARSE_VEB_FLAGS+=/c$(WORKSPACE)/$(BUILD_DIR)/Md5Checksum.txt
endif
